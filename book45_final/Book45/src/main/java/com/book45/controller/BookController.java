...
//	public ResponseEntity<List<ImageVO>> upload(@RequestParam("pictureUrl") MultipartFile[] pictureUrl) {
//		
//		for (MultipartFile multipartFile : pictureUrl) {
...
//		}
//		
//		String uploadFolder = "/Users/chaerilim/upload/temp";
//		
//		/* 날짜 폴더 경로 */
...
//		
//		File file = new File("/Users/chaerilim/upload/temp" + fileName);
//		
...
//		try {
//			/* 썸네일 이미지 삭제 */
//			file = new File("/Users/chaerilim/upload/temp" + URLDecoder.decode(fileName, "UTF-8"));
//			file.delete();
//			
//			/* 원본 이미지 삭제 */
//			String originFileName = file.getAbsolutePath().replace("s_", "");
//			log.info("원본 이미지: " + originFileName);
//			
...
//	public ResponseEntity<List<ImageVO>> getImageList(Long isbn) {
//		return new ResponseEntity<List<ImageVO>>(imageMapper.getImageList(isbn), HttpStatus.OK);
//	}
}
