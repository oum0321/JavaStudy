               ...
               <div class="totalInfoPrice">
                  <ul>
                     ...
                     <!-- <li class="point_li">
                        ...
                        <span class="totalPoint_span">10000원</span>
                     </li> -->
                  </ul>
               </div>
               <!-- 버튼 영역 -->
				<div class="totalInfoBtn">
					<!-- <form method="post" action="/kakaoPay">
						<button id="kakaoBtn">카카오페이로 결제하기</button>
					</form> -->
				
					<!-- <a href="/order/kakaoPay"><img src="/resources/img/payment_icon_yellow_small.png"></a> -->
...
$(".order_point_input").on("propertychange change keyup paste input", function(){
  ...
  function setTotalInfo(){
     ...
     //let totalPoint = 0; //총 마일리지(적립 마일리지)
     let delivery = 0; //배송비
