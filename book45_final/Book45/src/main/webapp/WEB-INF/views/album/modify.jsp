...
<div id="wrap" align="center">
	...
	<form id="modifyForm" role="form" action="/album/modify" method="post"> 
		...
		<button type="button" class="Btn" id="button" onclick="location.href='/album/list'">앨범 목록</button>
	</form> 
</div>
...
$("input[type='file']").on("change", function(e) {
	...
	let fileInput = $('input[name="albumPictureUrl"]');
	...
	formData.append("albumPictureUrl", fileObj);
