...
<div id="wrap" align="center">
	...
	<button type="button" id="listBtn" data-oper='list'>앨범 목록</button>
	<c:if test="${member.lev == 'A'}">
		<button type="button" id="regBtn" onclick="location.href='/book/register'">앨범 등록</button>
		<button type="button" id="modBtn" data-oper='modify'>앨범 수정</button>
