...
<link rel="stylesheet" type="text/css" href="/resources/css/album/best.css">
       ...
       <h2>베스트셀러</h2>
       	<table class="list">
			<tr class="record">
				<td>1</td>
				<td>
					<a class="move" href="9791161571188">
						<img alt="" src="http://image.yes24.com/goods/99308021/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 소설/시/희곡<br>
					<b>제목</b> &nbsp; 
					<a class="move" href='<c:out value="9791161571188"/>'>
						불편한 편의점
					</a>
					<br>
					<b>작가</b> &nbsp; 김호연 저<br>
			...
			<tr class="record">
				<td>2</td>
				<td>
					<a class="move" href='<c:out value="9788998658335"/>'>
						<img alt="" src="http://image.yes24.com/momo/TopCate712/MidCate003/71122359.jpg" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 자기계발<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>3</td>
				<td>
					<a class="move" href='<c:out value="9788954677158"/>'>
						<img alt="" src="http://image.yes24.com/goods/97255028/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 어린이<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>4</td>
				<td>
				<a class="move" href='<c:out value="9788997575169"/>'>
					<img alt="" src="http://image.yes24.com/goods/9349031/XL" id="cover">
				</a>
				</td>
				<td><b>카테고리</b> &nbsp; 자기계발<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>5</td>
				<td>
				<a class="move" href='<c:out value="9791189327156"/>'>
					<img alt="" src="http://image.yes24.com/goods/105526047/XL" id="cover">
				</a>
			...
			<tr class="record">
				<td>6</td>
				<td>
					<a class="move" href='<c:out value="9791191280333"/>'>
						<img alt="" src="http://image.yes24.com/goods/96794060/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 자기계발<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>7</td>
				<td>
					<a class="move" href='<c:out value="9791170400523"/>'>
						<img alt="" src="http://image.yes24.com/goods/104692009/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 인문<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>8</td>
				<td>
					<a class="move" href='<c:out value="9788934972464"/>'>
						<img alt="" src="http://image.yes24.com/goods/23030284/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 인문<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>9</td>
				<td>
					<a class="move" href='<c:out value="9788983711892"/>'>
						<img alt="" src="http://image.yes24.com/goods/2312211/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 자연과학<br>
					<b>제목</b> &nbsp; 
			...
			<tr class="record">
				<td>10</td>
				<td>
					<a class="move" href='<c:out value="9788932473901"/>'>
						<img alt="" src="http://image.yes24.com/goods/65067259/XL" id="cover">
					</a>
				</td>
				<td><b>카테고리</b> &nbsp; 자연과학<br>
					<b>제목</b> &nbsp; 
...
let isbn = actionForm.find("input[name='isbn']").val();
console.log("isbn: " + isbn);
$(".move").on("click",function(e){
	e.preventDefault();
	//추가
	actionForm.find("input[name='isbn']").remove();  //뒤로 간 후 리스트 클릭하면 num이 계속 쌓이는 문제
