...
<link rel="stylesheet" type="text/css" href="/resources/css/album/new.css">
		...
		<h2>신간 도서</h2>
        	<table class="list">
				<tr class="record">
					<td>1</td>
					<td>
						<a class="move" href='<c:out value="9788959897094"/>'>
							<img alt="" src="http://image.yes24.com/goods/113416767/XL" id="cover">
						</a>
					</td>
				...
				<tr class="record">
					<td>2</td>
					<td>
						<a class="move" href='<c:out value="9791130626659"/>'>
							<img alt="" src="http://image.yes24.com/goods/113789375/XL" id="cover">
						</a>
					</td>
				...
				<tr class="record">
					<td>3</td>
					<td>
						<a class="move" href='<c:out value="9788932474786"/>'>
							<img alt="" src="http://image.yes24.com/goods/114336082/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 예술<br>
						<b>제목</b> &nbsp; 
				...
				<tr class="record">
					<td>4</td>
					<td>
						<a class="move" href='<c:out value="9788954688796"/>'>
							<img alt="" src="http://image.yes24.com/goods/114273352/XL" id="cover">
						</a>
					</td>
				...
				<tr class="record">
					<td>5</td>
					<td>
						<a class="move" href='<c:out value="9791191859379"/>'>
							<img alt="" src="http://image.yes24.com/goods/114848694/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 에세이<br>
						<b>제목</b> &nbsp; 
				...
				<tr class="record">
					<td>6</td>
					<td>
						<a class="move" href='<c:out value="9788901265506"/>'>
							<img alt="" src="http://image.yes24.com/goods/114951396/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 경제 경영<br>
						<b>제목</b> &nbsp; 
				...
				<tr class="record">
					<td>7</td>
					<td>
						<a class="move" href='<c:out value="9791140701353"/>'>
							<img alt="" src="http://image.yes24.com/goods/113751739/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 자기계발<br>
						<b>제목</b> &nbsp; 
				...
				<tr class="record">
					<td>8</td>
					<td>
						<a class="move" href='<c:out value="9791187033882"/>'>
							<img alt="" src="http://image.yes24.com/goods/114857322/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 에세이<br>
						<b>제목</b> &nbsp; 
				...
				<tr class="record">
					<td>9</td>
					<td>
						<a class="move" href='<c:out value="9791191825619"/>'>
							<img alt="" src="http://image.yes24.com/goods/114648022/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 에세이<br>
						<b>제목</b> &nbsp; 
				...
				<tr class="record">
					<td>10</td>
					<td>
						<a class="move" href='<c:out value="9791198042804"/>'>
							<img alt="" src="http://image.yes24.com/goods/115053942/XL" id="cover">
						</a>
					</td>
					<td><b>카테고리</b> &nbsp; 에세이<br>
						<b>제목</b> &nbsp; 
