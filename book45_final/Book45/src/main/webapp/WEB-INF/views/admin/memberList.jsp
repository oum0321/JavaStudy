		...
		<table class="list" align="center">
			<tr>
				<td colspan="8" style="border: white; text-align: right">
					<input type="button" value="전체 주문 목록" id="orderList" onclick="location.href='/admin/orderList'">
				</td>
			</tr>
			<tr>
				<th>아이디</th> <th>이름</th> <th>전화번호</th> <th>이메일</th> <th>등급</th> <th colspan="3">회원 관리</th><!--  <th>주문내역</th> <th>삭제</th> -->
			</tr>
			<c:forEach var="member" items="${memberList}">
				<tr class="record">
					...
					<td><input type="button" value="주문 내역" id="btn" class="listBtn" data-oper="${member.id}" onclick="location.href='/member/orderList'"></td>
					<td><input type="button" value="회원 삭제" id="btn" onclick="location.href='/admin/delete?id=${member.id}'"></td>
					<!-- <td><input type="submit" value="삭제" id="btn" data-oper="delete" class="deleteBtn"></td> -->
				</tr>
			</c:forEach>
		</table>
	</div>
