...
<%-- 
	<table>
		...
		<tr>
			<th>내용</th>
			<td colspan="3">
				<textarea class="form-control" rows="10" cols="70" name="content" readonly>
...
let replyListInit = function(){
	$.getJSON("/qnareply/list", cri , function(obj){
		console.log("replyListInit 동작(답변 데이터 서버 요청 및 답변 동적 생성 메서드) 실행");
...
function makeReplyContent(obj) {
	...
	if(obj.list.length === 0){
		$(".reply_not_div").html('<span>답변은 잠시만 기다려주세요.</span>');
		...
		$(list).each(function(i,obj){
			...
			if(obj.id === userId){
				reply_list += '<a class="update_reply_btn" href="'+ obj.renum +'">수정</a><a class="delete_reply_btn" href="'+ obj.renum +'">삭제</a>';
			}
