...
<div id="wrap" align="center">
	...
	<form class="regForm" action="/book/register" method="post">
		<table>
			...
			<tr>
				...
				<td>
					...
					<div id="uploadResult">
					<!-- <div id="resultCard"><div class="imgDeleteBtn">X</div><img src="/book/display?fileName=rabbit.jpg"></div> -->
					</div>
				</td>
			</tr>
			<tr>
		...
		<input type="button" value="목록" class="Btn" onclick="location.href='/book/list'">
	</form>
</div>
