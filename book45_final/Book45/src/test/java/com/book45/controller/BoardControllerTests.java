...
public class BoardControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/boardRegister")
				.param("pass", "1234")
				.param("title", "테스트 새로운 제목 관리자")
				.param("content", "테스트 새로운 내용 관리자")
	...
	public void testRemove() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/boardRemove")
				.param("num", "2")
				).andReturn().getModelAndView().getViewName();
