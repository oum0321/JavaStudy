...
//	}
	...
	public void testInsertSelectKey() {
		...
		album.setProductNum(2929L);
		album.setCategory("매퍼 이미지 등록테스트 ");
		...
		System.out.println("Before AlbumVO : " +album);
		
		mapper.insertSelectKey(album);
		
		System.out.println("After AlbumVO : " +album);
...
//	@Test
//	public void imageEnrollTest() { //기본키는 값이 존재해야하고, 나머지 값은 존재하지않는 값이여야 한다.
//		
//		AlbumImageVO vo = new AlbumImageVO();
//		
//		vo.setProductNum(343L);
